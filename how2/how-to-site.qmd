...
Each time we mofify the page, we only need to re-run the `quarto publish` command. 
...
```{r}
#| eval: false
lugares <- c("Lugares - México", "Lugares - Europa", "Lugares - Sur América", "Eventos - Venezuela", "Visita a Colombia - Oct 2024", "Santiago - Nuevo León", "Lugares - Australia")
